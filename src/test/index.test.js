...
const transform = (code, opts = {}) => babel.transform(code, { babelrc: false, plugins: [[plugin, opts]] }).code;
...
test('importing a existing directory without index file listTransform, sort by depth', () => {
  ...
  expect(transform(orig, { listTransform })).toEqual(`import "./src/test/fixtures/fake-module-b";
import "./src/test/fixtures/fake.module.a";
